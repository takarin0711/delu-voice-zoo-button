...
<img width="600" height="400" alt="Image" src="https://github.com/user-attachments/assets/d7d49a37-057c-442a-b5e0-303a243bb1f2" />
...
├── icon/           # アイコン画像（拡張機能用: 16x16, 48x48, 128x128 / ウェブページ用: youtube.png）
